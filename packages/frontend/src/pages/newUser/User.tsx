...
export function User(props: UserProps) {
    return(
        <Page path='/newUser' description='User page' account={props.account}>
            <ActionsTable withdrawableAssets={props.withdrawableAssets} offersToAccept={props.offersToAccept} />
            <AssetsTable assets={props.assets} />
            <BalanceChangesTable balanceChanges={props.balanceChanges} />
            <EthereumTransactionsTable ethereumTransactions={props.ethereumTransactions} />
