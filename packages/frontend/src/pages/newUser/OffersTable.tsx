...
export function OffersTable({offers}: OffersTableProps) {
    return(<NewTable pageSize={6} id='test' title="Offers" noRowsText="You have no offers" columns={[{header: 'TIME'}, {header: 'ASSET'}, {header: 'AMOUNT'}, {header: 'PRICE'}, {header: "TOTAL PRICE"}, {header: 'STATUS'}, {header: 'TYPE'}]} 
