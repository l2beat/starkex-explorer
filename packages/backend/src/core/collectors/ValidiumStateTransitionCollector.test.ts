    ...
    it('collects data properly for spot trading', async () => {
      ...
      mockGetLogsInRange.returns(
        Promise.resolve([
          {
            blockNumber: 7344486,
            blockHash: '0xab2bde61ea56af1e7ea9b1f6dabbc930bb98452ab8bba28ac93a5d6ebf9638cb',
            transactionIndex: 54,
            removed: false,
            ...
            transactionHash: '0xc80951be315784099930a5e23ce63cfe6d653c4714a206abee00fcb6869782dd',
            logIndex: 107
          },
          {
            blockNumber: 7344486,
      ...
      const transitions = await collector.collect(mockBlockRange)
       ...
       const testTransitions = [
         {
           blockNumber: 7344486,
           transactionHash: Hash256('0xc80951be315784099930a5e23ce63cfe6d653c4714a206abee00fcb6869782dd'),
           stateTransitionHash: Hash256("0xb760c05d917476eb1ef587535fcabf68638fa8080bba8d420780493775fd9ab8"),
           sequenceNumber: 497,
           batchId: 515
         }
       ]
      ...
      const testRecords = [
        { blockNumber: 7344486, stateTransitionHash: Hash256("0xb760c05d917476eb1ef587535fcabf68638fa8080bba8d420780493775fd9ab8") },
      ]
    ...
    it('collects data properly for perpetual trading', async () => {
      ...
      mockGetLogsInRange.returns(
        Promise.resolve([
          {
            blockNumber: 7549714,
            blockHash: '0x9e6a60bb32bba378f026264278ec7d6a898751947c0e12b09a45b6b60d4bb3b0',
            transactionIndex: 32,
            removed: false,
            ...
            transactionHash: '0xf93660b7282f9dce233f54509a4085833f3d6b8024ad78ac72a8bcf1eaeab344',
            logIndex: 83
          },
          {
            blockNumber: 7549714,
      ...
      const testRecords = [
        { blockNumber: 7549714, stateTransitionHash: Hash256("0x9355065eb4c6a9e63cc756ed12a06894294ece370ceeb232f82c65366ac6caf1") },
      ]

      const testTransitions = [
        {
          blockNumber: 7549714,
          transactionHash: Hash256('0xf93660b7282f9dce233f54509a4085833f3d6b8024ad78ac72a8bcf1eaeab344'),
          stateTransitionHash: Hash256('0x9355065eb4c6a9e63cc756ed12a06894294ece370ceeb232f82c65366ac6caf1'),
          sequenceNumber: 32,
          batchId: 940
        }
      ]
