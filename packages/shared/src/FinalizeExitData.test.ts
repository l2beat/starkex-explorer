...
const exampleData =
  '0x441a3e70070a6100ed8ef5dd2d61e6d00de188e1ef2ac191f6178d99781150a04e889fd302893294412a4c8f915f75892b395ebbf6859ec246ec365c3b1f56f47c3a0a5d'
...
describe(decodeFinalizeExitRequest.name, () => {
  it('encodes an example tx', () => {
    expect(decodeFinalizeExitRequest(exampleData)).toEqual({
      starkKey,
      assetType: '0x02893294412a4c8f915f75892b395ebbf6859ec246ec365c3b1f56f47c3a0a5d',
    })
  })
})
